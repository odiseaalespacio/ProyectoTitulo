...
public class NotificacionController {
	...
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or @authz.ownsApoderado(#idApoderado)")
	...
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or @authz.ownsEvento(#idEvento)")
	...
	@GetMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or @authz.ownsNotificacion(#id)")
	public Notificacion obtener(@PathVariable Integer id) {
		return notificacionService.obtener(id);
	}

	@PostMapping
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or (hasRole('COLEGIO') and @authz.colegioPuedeGestionarNotificacionRequest(#body))")
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or (hasRole('COLEGIO') and @authz.colegioPuedeGestionarNotificacionId(#id) and @authz.colegioPuedeGestionarNotificacionRequest(#body))")
	...
	@DeleteMapping("/{id}")
	@PreAuthorize("hasAnyRole('ADMINISTRADOR','SUPER_USUARIO') or (hasRole('COLEGIO') and @authz.colegioPuedeGestionarNotificacionId(#id))")
